...
namespace Microsoft.Azure.Management.Support
{
    ...
    internal partial class CommunicationsOperations : IServiceOperations<MicrosoftSupportClient>, ICommunicationsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<CommunicationDetails>>> ListBySubscriptionTicketWithHttpMessagesAsync(string supportTicketName, int? top = default(int?), string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "ListBySubscriptionTicket", tracingParameters);
            }
            // Construct URL
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CommunicationDetails>> GetBySubscriptionTicketWithHttpMessagesAsync(string supportTicketName, string communicationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (supportTicketName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "supportTicketName");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "GetBySubscriptionTicket", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<CommunicationDetails>>> ListBySubscriptionTicketNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "ListBySubscriptionTicketNext", tracingParameters);
            }
            // Construct URL
